...
if (isset($_POST['ids'])) {
    ...
    if (isset($_GET['movieId'])) {
        $deleteIds = $_GET['movieId'];
    }
if (isset($deleteIds)) {
    get_connection();
    $deleteSQL = "delete from movie where id in ($deleteIds)";
...
$nowSQL = "select * from movie order by id desc limit $start,$pageSize";
get_connection();
...
<body>
	...
	<br>
	<br>
	<form action="deleteMovie.php" id="myform" method="post">
		<table align="center" style="width: 500px;">
			<tr>
				<td colspan="5" align="center" height="60"
					style="border-color: #e5e2e2; line-height: 30px; font-size: 25px;">删除电影</td>
			</tr>
			<tr>
				<td colspan="5">
					<table class="layui-table" border="1" cellspacing="0"
						...
						<tr height="30" style="background-color: #e5e2e2;">
							...
							<td align="center" width="180">电影名</td>
                        ...
                        <tr height="160">
							...
							<td align="center"><a
								...
								href="deletemovie.php?movieId=<?php echo $movie['id'] ?>"
			...
			<tr>
				<td colspan="5" width="190" height="40" align="center"><input
					...
					value="  删 除 所 选 项  " onclick="submitCheck();"></td>
			</tr>
		</table>
