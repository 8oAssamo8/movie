...
if (isset($_POST['ids'])) {
    ...
    if (isset($_GET['userId'])) {
        $deleteIds = $_GET['userId'];
    }
if (isset($deleteIds)) {
    get_connection();
    $deleteSQL = "delete from user where id in ($deleteIds)";
...
$nowSQL = "select * from user order by id desc limit $start,$pageSize";
get_connection();
					...
					<table class="layui-table" border="1" cellspacing="0"
                        ...
                        <tr height="120">
							...
							<td align="center"><a
								...
								href="deleteUser.php?userId=<?php echo $user['id'] ?>"
